<template>
  <q-btn-dropdown
    :model-value="dropdownRef"
    @update:model-value="onUpdateModelState"
    stretch
    flat
...
<script setup lang="ts">
  ...
  const formattedRange = computed(() => {
    ...
    const finalMin = min * multiplier;
    const finalMax = max * multiplier;
    const limit = 5;
  ...
  function onUpdateModelState(value: any) {
